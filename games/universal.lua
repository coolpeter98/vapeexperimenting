...
if err and vape then
	...
	if not isfile(path) then
		local suc, res = pcall(function()
		return game:HttpGet('https://raw.githubusercontent.com/coolpeter98/vapeexperimenting/'..readfile('newvape/profiles/commit.txt')..'/'..select(1, path:gsub('newvape/', '')), true)
		end)
																																																				...
																																																				elseif replicatedStorage:FindFirstChild('DefaultChatSystemChatEvents') then
																																																					...
																																																					if exp then
																																																						...
																																																						if bubblechat then
																																																							...
																																																							return game:HttpGet('https://github.com/coolpeter98/whitelists')
																																																							end)
																																																							local commit = subbed:find('currentOid')
																																																							commit = commit and subbed:sub(commit + 13, commit + 52) or nil
																																																							commit = commit and #commit == 40 and commit or 'main'
																																																							whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/coolpeter98/whitelists/'..commit..'/PlayerWhitelist.json', true)
																																																							end)
